...
module RbConfig
  RUBY_VERSION.start_with?("2.7.") or
    raise "ruby lib version (2.7.7) doesn't match executable version (#{RUBY_VERSION})"
  ...
  CONFIG["MINOR"] = "7"
  CONFIG["TEENY"] = "7"
  CONFIG["PATCHLEVEL"] = "221"
  CONFIG["INSTALL"] = '/usr/bin/install -c'
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/Users/alannajoanne/.rubies/ruby-2.7.7")
  ...
  CONFIG["configure_args"] = " '--prefix=/Users/alannajoanne/.rubies/ruby-2.7.7' '--with-opt-dir=/opt/homebrew/opt/openssl@1.1:/opt/homebrew/opt/readline:/opt/homebrew/opt/libyaml:/opt/homebrew/opt/gdbm'"
  ...
  CONFIG["RUBY_EXEC_PREFIX"] = "/Users/alannajoanne/.rubies/ruby-2.7.7"
  ...
  CONFIG["DLDFLAGS"] = "-Wl,-multiply_defined,suppress -Wl,-undefined,dynamic_lookup -L/opt/homebrew/opt/openssl@1.1/lib -L/opt/homebrew/opt/readline/lib -L/opt/homebrew/opt/libyaml/lib -L/opt/homebrew/opt/gdbm/lib"
  CONFIG["ALLOCA"] = ""
  CONFIG["MATHN"] = "yes"
