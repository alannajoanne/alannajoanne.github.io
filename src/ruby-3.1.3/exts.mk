...
extensions = ext/-test-/RUBY_ALIGNOF/. ext/-test-/arith_seq/extract/. \
	     ...
	     ext/syslog/. ext/zlib/. \
	     .bundle/gems/debug-1.6.3/ext/debug/. \
	     .bundle/gems/rbs-2.7.0/ext/rbs_extension/.
EXTOBJS = dmyext.o
...
ext/zlib/all:
	$(Q)$(MAKE) -C $(@D) V=$(V) $(@F)
.bundle/gems/debug-1.6.3/ext/debug/all:
	$(Q)$(MAKE) -C $(@D) V=$(V) $(@F)
.bundle/gems/rbs-2.7.0/ext/rbs_extension/all:
	$(Q)$(MAKE) -C $(@D) V=$(V) $(@F)
...
ext/zlib/static:
	$(Q)$(MAKE) -C $(@D) V=$(V) $(@F)
.bundle/gems/debug-1.6.3/ext/debug/static:
	$(Q)$(MAKE) -C $(@D) V=$(V) $(@F)
.bundle/gems/rbs-2.7.0/ext/rbs_extension/static:
	$(Q)$(MAKE) -C $(@D) V=$(V) $(@F)
...
ext/zlib/install:
	$(Q)$(MAKE) -C $(@D) V=$(V) $(@F)
.bundle/gems/debug-1.6.3/ext/debug/install:
	$(Q)$(MAKE) -C $(@D) V=$(V) $(@F)
.bundle/gems/rbs-2.7.0/ext/rbs_extension/install:
	$(Q)$(MAKE) -C $(@D) V=$(V) $(@F)
...
ext/zlib/install-so:
	$(Q)$(MAKE) -C $(@D) V=$(V) $(@F)
.bundle/gems/debug-1.6.3/ext/debug/install-so:
	$(Q)$(MAKE) -C $(@D) V=$(V) $(@F)
.bundle/gems/rbs-2.7.0/ext/rbs_extension/install-so:
	$(Q)$(MAKE) -C $(@D) V=$(V) $(@F)
...
ext/zlib/install-rb:
	$(Q)$(MAKE) -C $(@D) V=$(V) $(@F)
.bundle/gems/debug-1.6.3/ext/debug/install-rb:
	$(Q)$(MAKE) -C $(@D) V=$(V) $(@F)
.bundle/gems/rbs-2.7.0/ext/rbs_extension/install-rb:
	$(Q)$(MAKE) -C $(@D) V=$(V) $(@F)
...
ext/zlib/clean:
	$(Q)$(MAKE) -C $(@D) V=$(V) $(@F)
.bundle/gems/debug-1.6.3/ext/debug/clean:
	$(Q)$(MAKE) -C $(@D) V=$(V) $(@F)
.bundle/gems/rbs-2.7.0/ext/rbs_extension/clean:
	$(Q)$(MAKE) -C $(@D) V=$(V) $(@F)
...
ext/zlib/distclean:
	...
	$(Q)$(RMDIRS) $(@D)
.bundle/gems/debug-1.6.3/ext/debug/distclean:
	$(ECHO) $(@F)ing $(@D)
	$(Q)$(MAKE) -C $(@D) V=$(V) $(@F)
	$(Q)$(RM) .bundle/gems/debug-1.6.3/exts.mk
	$(Q)$(RMDIRS) $(@D)
.bundle/gems/rbs-2.7.0/ext/rbs_extension/distclean:
	$(ECHO) $(@F)ing $(@D)
	$(Q)$(MAKE) -C $(@D) V=$(V) $(@F)
	$(Q)$(RM) .bundle/gems/rbs-2.7.0/exts.mk
	$(Q)$(RMDIRS) $(@D)
...
ext/zlib/realclean:
	...
	$(Q)$(RM) ext/zlib/exts.mk
	$(Q)$(RMDIRS) $(@D)
.bundle/gems/debug-1.6.3/ext/debug/realclean:
	$(ECHO) $(@F)ing $(@D)
	$(Q)$(MAKE) -C $(@D) V=$(V) $(@F)
	$(Q)$(RM) .bundle/gems/debug-1.6.3/exts.mk
	$(Q)$(RMDIRS) $(@D)
.bundle/gems/rbs-2.7.0/ext/rbs_extension/realclean:
	$(ECHO) $(@F)ing $(@D)
	$(Q)$(MAKE) -C $(@D) V=$(V) $(@F)
	$(Q)$(RM) .bundle/gems/rbs-2.7.0/exts.mk
	$(Q)$(RMDIRS) $(@D)
