...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/Users/alannajoanne/.rubies/ruby-3.1.3")
  ...
  CONFIG["configure_args"] = " '--prefix=/Users/alannajoanne/.rubies/ruby-3.1.3' '--with-opt-dir=/opt/homebrew/opt/readline:/opt/homebrew/opt/libyaml:/opt/homebrew/opt/gdbm' '--with-openssl-dir=/opt/homebrew/opt/openssl@3'"
  ...
  CONFIG["RUBY_EXEC_PREFIX"] = "/Users/alannajoanne/.rubies/ruby-3.1.3"
  ...
  CONFIG["LDFLAGS"] = "-L. -fstack-protector-strong -L/opt/homebrew/opt/readline/lib -L/opt/homebrew/opt/libyaml/lib -L/opt/homebrew/opt/gdbm/lib -L/usr/local/lib"
