...
module RbConfig
  ...
  TOPDIR = File.dirname(__FILE__).chomp!("/lib/ruby/3.1.0/arm64-darwin20")
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/Users/alannajoanne/.rubies/ruby-3.1.1")
  ...
  CONFIG["configure_args"] = " '--prefix=/Users/alannajoanne/.rubies/ruby-3.1.1' '--with-opt-dir=/opt/homebrew/opt/openssl@1.1:/opt/homebrew/opt/readline:/opt/homebrew/opt/libyaml:/opt/homebrew/opt/gdbm'"
  ...
  CONFIG["RUBY_EXEC_PREFIX"] = "/Users/alannajoanne/.rubies/ruby-3.1.1"
  ...
  CONFIG["STATIC"] = ""
  CONFIG["ARCH_FLAG"] = ""
  CONFIG["DLDFLAGS"] = "-Wl,-undefined,dynamic_lookup -Wl,-multiply_defined,suppress -L/opt/homebrew/opt/openssl@1.1/lib -L/opt/homebrew/opt/readline/lib -L/opt/homebrew/opt/libyaml/lib -L/opt/homebrew/opt/gdbm/lib"
  CONFIG["ALLOCA"] = ""
  ...
  CONFIG["LDFLAGS"] = "-L. -fstack-protector-strong -L/usr/local/lib -L/opt/homebrew/opt/openssl@1.1/lib -L/opt/homebrew/opt/readline/lib -L/opt/homebrew/opt/libyaml/lib -L/opt/homebrew/opt/gdbm/lib"
