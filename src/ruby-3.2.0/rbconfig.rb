...
module RbConfig
  ...
  TOPDIR = File.dirname(__FILE__).chomp!("/lib/ruby/3.2.0/arm64-darwin20")
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/Users/alannajoanne/.rubies/ruby-3.2.0")
  ...
  CONFIG["configure_args"] = " '--prefix=/Users/alannajoanne/.rubies/ruby-3.2.0' '--with-opt-dir=/opt/homebrew/opt/openssl@1.1:/opt/homebrew/opt/readline:/opt/homebrew/opt/libyaml:/opt/homebrew/opt/gdbm'"
  ...
  CONFIG["RUBY_EXEC_PREFIX"] = "/Users/alannajoanne/.rubies/ruby-3.2.0"
